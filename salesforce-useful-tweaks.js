...
toolbox += '<br />Case comments: <strong>' + case_comments + '</strong> total'
...
var m = log_call.match(/navigateToUrl(.*?['"]([^'"]*)['"])/);

var related_lists = document.querySelectorAll('.efdvJumpLinkBody > ul')
related_lists[0].insertAdjacentHTML('beforeend', '<hr /><li><a href="https://' + document.domain + m[2] + '">Log a Call</a></li>');

toolbox += '<br /><br />&#9742;&nbsp;<a style="display:inline;margin:0; padding:0;" href="https://'+document.domain+m[2]+'">Log a Call</a>'
